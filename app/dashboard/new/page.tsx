        ...
        {coverImageUrl ? (
          <div className="relative group rounded overflow-hidden" style={{ height: '220px' }}>
            ...
            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
              <label htmlFor="cover-upload-new" className="cursor-pointer text-white text-sm px-3 py-1.5 rounded-md bg-black/30 hover:bg-black/50 backdrop-blur-sm transition-colors">
          ...
          <label htmlFor="cover-upload-new" className="flex items-center gap-2 text-sm cursor-pointer transition-opacity hover:opacity-60" style={{ color: uploading ? 'var(--text-tertiary)' : 'var(--text-tertiary)' }}>
